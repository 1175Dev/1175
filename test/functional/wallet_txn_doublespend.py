...
class TxnMallTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ESF:
        ...
        # First: use raw transaction API to send 1240 ESF to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ESF coin each
        ...
        # Node0's balance should be starting balance, plus 50ESF for another
        ...
        # Node0's total balance should be starting balance, plus 100ESF for

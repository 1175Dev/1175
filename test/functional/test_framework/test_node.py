...
class TestNode():
    ...
    PRIV_KEYS = [
            # address , privkey
            # 1175 regtest (P2PKH version 100, WIF version 240); re-encoded from the same
            # private keys as upstream so downstream deterministic assumptions are preserved.
            AddressKeyPair('hJk7fqwZszTykHneSpFNEVqom2i67dW1Hs', 'cePsiBR93yHq6qkKRk6aLKCG2Q86vdxMgA5fvLhqPprmydq6nYcQ'),
            AddressKeyPair('hSoTuDFm9jH4xGs8kmf911s3wHj2mNR1Xj', 'cdYW68gsjJGJNyawFYoQ6wH5hMV1ms3e5WmTFQkacHK7kNXH7fhX'),
            AddressKeyPair('hN69NAh7LUfXsgC65TUiYDHUMYD6DnCUFN', 'ccSKgo78LoDm5747ybYVMVE8gCaVKcd1Cn4cJgPiviyhH4e8GPkW'),
            AddressKeyPair('hQbGzPaxQtwGf7MSxJpX2u3mYb5Bna6nTJ', 'ceUwtjUamocNPSWbf5WbLngiPf3RfXaxLmTeEyCdg3mubf4YDpqS'),
            AddressKeyPair('hSpwmv9kp6tJmLHHW95UdKbYHn198PsS5u', 'cYnpm4gWujhxVjpyPf1GEueAD5cNxgMvLKu8nL6971jYchQYEhme'),
            AddressKeyPair('hc9A5HWmXhSCfPDnm95RAP8m9diwHHQfh1', 'cZAPLpkLWbkTGVN1q1Zj7TmzjA1K8crQeiKqjWfJ5CYHvXffdsE8'),
            AddressKeyPair('hZHGZm9n4fxHvWTHeNj9ymP16sqZnBmHaL', 'cYwSnVfqLH8KcfPNxg2hEm6fxCTcL9mwF847QnuJPJexRtvPVaP6'),
            AddressKeyPair('hV4JdP5iny8kV7Qp4ZWriYMVsibWTABCbi', 'cb7PzUtPnxj3ftPGNgmD3r4MiJfTNW6eLaqdRi6xjUz6C7htEbbK'),
            AddressKeyPair('hPmUk5AXYmCZZv4YqdSDEJsGyqTMkhwETT', 'cbPATGFfDym72ZV88fvzSeZFfUr6JxXcLULVxfcn5XFC4m8y38Lv'),
            AddressKeyPair('hQM2MBMSwHoHYGEmU1V5RjDmx3aoCDCA6g', 'cWeiCk1uTxp59ggvsata1nuK5Cg24JgAq2jeuNEYq7vPmwK5bEYT'),
            AddressKeyPair('hPXXT2TMJLm1gaWuECE8CcR7q47WkxLB9H', 'cbhTtH2v7uTNLSLaVhRTeh6iL6HxEXj5BVicEHwJDSzq2tyRFTtz'),
            AddressKeyPair('hZi1JDHBrHcS8ZSYwFyXKaxaLK8exN5XkF', 'cYJ45PVDXtNZvo284pnYesmHXgyjYhfEekhhxJ5bcriUvGt27PW6'),
    ]

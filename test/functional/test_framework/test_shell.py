...
class TestShell:
    """Wrapper Class for ElevenSeventyFiveTestFramework.

    The TestShell class extends the ElevenSeventyFiveTestFramework
    ...
    class __TestShell(ElevenSeventyFiveTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ElevenSeventyFiveTestFramework child class.
            self.num_nodes = 1

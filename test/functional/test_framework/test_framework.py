...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def set_binary_paths(self):
        ...
        binaries = {
            "elevenseventyfived": ("bitcoind", "BITCOIND"),
            "elevenseventyfive-cli": ("bitcoincli", "BITCOINCLI"),
            "elevenseventyfive-util": ("bitcoinutil", "BITCOINUTIL"),
            "elevenseventyfive-wallet": ("bitcoinwallet", "BITCOINWALLET"),
        }

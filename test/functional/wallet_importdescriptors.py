...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["resf1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7zqmwyq", "resf1qfqeppuvj0ww98r6qghmdkj70tv8qpche9pv2y5"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'resf1qtmp74ayg7p24uslctssvjm06q5phz4yr5yupll', # m/0'/0'/0
            'resf1q8vprchan07gzagd5e6v9wd7azyucksq25q6n65', # m/0'/0'/1
            'resf1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjnam4n0', # m/0'/0'/2
            'resf1qau64272ymawq26t90md6an0ps99qkrsexllneu', # m/0'/0'/3
            'resf1qsg97266hrh6cpmutqen8s4s962aryy77qetqyu', # m/0'/0'/4
        ]
        ...
        assert_equal(address, "hPSPgVsU7aMUythPZPpHX6mWt4FTPXCkAh")
        ...
        wif_priv = "ccDeEFDXdH5GBmhG4Y8sC7Fh7eaxBZwPDrQopQppSgCeCvrTGaAz"
        ...
        assert_equal(addr, 'resf1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqepxjgw') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32') # uses change 0
        assert_equal(change_addr, 'resf1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnshv3kts') # Derived at m/84'/1'/0'/0
        ...
        assert_equal(addr, 'resf1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqqrlf0v') # Derived at m/84'/0'/0'/1
        change_addr = wmulti_pub.getrawchangeaddress('bech32') # uses change 2
        assert_equal(change_addr, 'resf1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjusqhszr3') # Derived at m/84'/1'/0'/2
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
            with self.nodes[0].assert_debug_log(expected_msgs=["Rescan started from block 79f89eecf43f07b684f5c00382fe7a26455f921d51973282ba9ea5ff69f7bcc9... (slow variant inspecting all blocks)"], timeout=10):

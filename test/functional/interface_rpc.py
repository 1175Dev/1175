...
class RPCInterfaceTest(BitcoinTestFramework):
    ...
    def test_batch_request(self, call_options):
        ...
        results = [
            ...
            {"result": "79f89eecf43f07b684f5c00382fe7a26455f921d51973282ba9ea5ff69f7bcc9"},
    ...
    def test_http_status_codes(self):
        ...
        expect_http_rpc_status(204, None,                   self.nodes[0], "generatetoaddress", [1, "resf1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqlwcrre"],  2, True)

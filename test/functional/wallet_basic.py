...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            assert_raises_rpc_error(-5, "Bech32m addresses cannot be imported into legacy wallets", self.nodes[0].importaddress, "resf1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqt7v73n")
        ...
        address_info = self.nodes[0].getaddressinfo("hMvueaEP4veUmCumCpHhNfAd3JLTjD3Lez")
        assert_equal(address_info['address'], "hMvueaEP4veUmCumCpHhNfAd3JLTjD3Lez")

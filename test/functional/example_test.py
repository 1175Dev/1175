...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ElevenSeventyFiveTestFramework
    pass


class ExampleTest(ElevenSeventyFiveTestFramework):
    # Each functional test is a subclass of the ElevenSeventyFiveTestFramework class.
    ...
    def custom_method(self):
        ...
        ElevenSeventyFiveTestFramework class so other tests can use it."""

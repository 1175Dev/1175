...
# 1175: regtest genesis nTime (chainparams.cpp). Stock Bitcoin's
# TIME_GENESIS_BLOCK (1296688602) equals its regtest genesis time; the 1175
# analog is the 1175 regtest genesis time so setmocktime() sits at/after the
# genesis median-time-past instead of ~15 years before it.

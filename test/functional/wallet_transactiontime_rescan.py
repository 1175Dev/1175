...
class TransactionTimeRescanTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine ESF and create transactions
        ...
        # generate some esf to create transactions and check blockcount
        ...
        # send 10 esf to user's first watch-only address
        self.log.info('Send 10 esf to user')
        ...
        # send 5 esf to our second watch-only address
        self.log.info('Send 5 esf to user')
        ...
        # send 1 esf to our third watch-only address
        self.log.info('Send 1 esf to user')

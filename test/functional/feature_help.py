...
"""Verify that starting elevenseventyfive with -h works as expected."""

from test_framework.test_framework import ElevenSeventyFiveTestFramework
from test_framework.util import assert_equal

class HelpTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        self.log.info("Start elevenseventyfive with -h for help text")
        ...
        self.log.info("Start elevenseventyfive with -version for version information")
        ...
        self.log.info("Start elevenseventyfived with -fakearg to make sure it does not start")

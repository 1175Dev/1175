...
class NetTest(ElevenSeventyFiveTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=25360)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 25360)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=25360), {"success": False})

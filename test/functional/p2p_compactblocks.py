...
# TestP2PConn: A peer we use to send messages to elevenseventyfived, and store responses.
...
class CompactBlocksTest(ElevenSeventyFiveTestFramework):
    ...
    # This test actually causes elevenseventyfived to (reasonably!) disconnect us, so do this last.
    ...
    # elevenseventyfived's choice of nonce.
    ...
    # Test that elevenseventyfived requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for elevenseventyfived to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # elevenseventyfived will not send blocktxn responses for blocks whose height is

...
"""
Test starting elevenseventyfived with -bind and/or -bind=...=onion and confirm
...
from test_framework.test_framework import (
    ElevenSeventyFiveTestFramework,
    SkipTest,
)
...
class BindExtraTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that elevenseventyfived has bound on "::1" (for RPC) and "::" (for P2P).

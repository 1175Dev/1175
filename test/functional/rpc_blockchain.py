...
# 1175 regtest genesis nTime (see kernel/chainparams.cpp CreateGenesisBlock);
# differs from Bitcoin's blocktools.TIME_GENESIS_BLOCK (1296688602).
...
DIFFICULTY_ADJUSTMENT_INTERVAL = 1175  # 1175 regtest: nPowTargetTimespan / nPowTargetSpacing

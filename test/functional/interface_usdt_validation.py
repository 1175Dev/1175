...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/elevenseventyfive/elevenseventyfive/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/elevenseventyfive/elevenseventyfive/blob/master/doc/tracing.md#tracepoint-validationblock_connected

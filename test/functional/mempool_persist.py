...
By default, elevenseventyfived will dump mempool on shutdown and
...
class MempoolPersistTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent elevenseventyfived from writing mempool.dat to disk. Verify that `savemempool` fails")

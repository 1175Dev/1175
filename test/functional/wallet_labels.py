...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        common_address = "hSwRgh5qjRDtvcMyMdtNovC8YfBsNCw5PQ"
        node.sendmany(
        ...
        if self.options.descriptors:
            ...
            BECH32_VALID = {
                '✔️_VER15_PROG40': 'resf10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqquwmyzw',
                '✔️_VER16_PROG03': 'resf1sqqqqqu9pnpu',
                '✔️_VER16_PROB02': 'resf1sqqqqkm6gvf',
            }
            BECH32_INVALID = {
                '❌_VER15_PROG41': 'resf1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq79rr38',
                '❌_VER16_PROB01': 'resf1sqq2catvy',
            }

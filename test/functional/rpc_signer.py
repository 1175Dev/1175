...
Verify that a elevenseventyfived node can use an external signer command.
...
class RPCSignerTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart elevenseventyfived with -signer=<cmd>',

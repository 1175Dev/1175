...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def test_invalid_snapshot_scenarios(self, valid_snapshot_path):
        ...
        invalid_magics = [
            # magic, name, real  (1175 network magics; signet is challenge-derived and
            # matches Bitcoin's because 1175 uses the same default signet challenge)
            [0x74ba1be4, "main", True],
            [0x1e3ca746, "test", True],
    ...
    def test_headers_not_synced(self, valid_snapshot_path):
        for node in self.nodes[1:]:
            msg = "Unable to load UTXO snapshot: The base block header (4a0be6bfa0cab646be75a04a4db02e9624183f5929e623eef5878fe17c9a32f6) must appear in the headers chain. Make sure all headers are syncing, and call loadtxoutset again."
    ...
    def test_snapshot_block_invalidated(self, dump_output_path):
        ...
        for height in [SNAPSHOT_BASE_HEIGHT, SNAPSHOT_BASE_HEIGHT - 1]:
            ...
            msg = "Unable to load UTXO snapshot: The base block header (4a0be6bfa0cab646be75a04a4db02e9624183f5929e623eef5878fe17c9a32f6) is part of an invalid chain."
            assert_raises_rpc_error(-32603, msg, node.loadtxoutset, dump_output_path)

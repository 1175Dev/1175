...
class RejectLowDifficultyHeadersTest(BitcoinTestFramework):
    ...
    def test_chains_sync_when_long_enough(self):
        ...
        for node in self.nodes[1:3]:
            ...
            assert {
                'height': 0,
                'hash': '79f89eecf43f07b684f5c00382fe7a26455f921d51973282ba9ea5ff69f7bcc9',
                'branchlen': 0,
                'status': 'active',
            } in chaintips
    ...
    def test_peerinfo_includes_headers_presync_height(self):
        ...
        # Send a full batch (MAX_HEADERS_RESULTS) of headers, forking from genesis.
        new_blocks = []
        hashPrevBlock = int(node.getblockhash(0), 16)
        for i in range(MAX_HEADERS_RESULTS):

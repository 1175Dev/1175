...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "resf1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th6473qtm")
        ...
        assert_equal(address3, "hacgpXtQpP14gFituv8xfwsHbX4wAAzN9w")
        ...
        assert_equal(address4, "resf1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62msxqp4vm")
        ...
        assert_equal(address_fail, "resf1ql7zg7ukh3dwr25ex2zn9jse926f27xy2q6sw8g")

...
class ToolWalletTest(ElevenSeventyFiveTestFramework):
    ...
    def elevenseventyfive_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + '/src/elevenseventyfive-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def assert_raises_tool_error(self, error, *args):
        p = self.elevenseventyfive_wallet_process(*args)
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `elevenseventyfive-wallet help` raises an error. Use `elevenseventyfive-wallet -help`.
    ...
    def test_salvage(self):
        # TODO: Check salvage actually salvages and doesn't break things. https://github.com/elevenseventyfive/elevenseventyfive/issues/7463

...
class InvalidMessagesTest(ElevenSeventyFiveTestFramework):
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure elevenseventyfived signals support for ADDRv2, otherwise this test

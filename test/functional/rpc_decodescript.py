...
class DecodeScriptTest(ElevenSeventyFiveTestFramework):
    ...
    def decodescript_miniscript(self):
        ...
        # Sourced from https://github.com/elevenseventyfive/elevenseventyfive/pull/27037#issuecomment-1416151907.

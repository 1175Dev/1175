    ...
    def on_addr(self, message):
        for addr in message.addrs:
            ...
            if self.test_addr_contents:
                ...
                if not 25360 <= addr.port < 8343:
                    raise AssertionError("Invalid addr.port of {} (25360-8342 expected)".format(addr.port))
...
class AddrTest(ElevenSeventyFiveTestFramework):
    counter = 0

...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.sendtodestination("hKZrAzp8XiYhohuVHw5ccfFdALxaKjPFXv", 0.008)  # (m/0'/0'/0')
        self.sendtodestination("hJ6qcEV8MjvgrxuybmkPT19KrvyQGWibbf", 0.016)  # (m/0'/0'/1')
        self.sendtodestination("hcPzL5MvYqueGacvnySLurFDHizjQEdZF3", 0.032)  # (m/0'/0'/1500')
        self.sendtodestination("hQiWbdPxyPEY1BiHhG1jzpoLMe3Rd2Buei", 0.064)  # (m/0'/0'/0)
        self.sendtodestination("hMk3FVDM34kxhX3NThFbtrExBYjTSCG8YS", 0.128)  # (m/0'/0'/1)
        self.sendtodestination("hKwFNRp1LV3qesUkwGAJsvJXN86LNz8m1W", 0.256)  # (m/0'/0'/1500)
        self.sendtodestination("hJRMRoaRNdXwWmGyvnMJ4B5BoFM8Ar9PcZ", 0.512)  # (m/1/1/0')
        self.sendtodestination("hF4gz884ruh5b2h4SvEr2GPkYVZ6zobNAR", 1.024)  # (m/1/1/1')
        self.sendtodestination("hPBTmyjamPv9NXp4cFJzmASHs5EVreSsgf", 2.048)  # (m/1/1/1500')
        self.sendtodestination("hTwqyHJnLLyFzkdUZKMJ7txs4FyK3NmE5g", 4.096)  # (m/1/1/0)
        self.sendtodestination("hY6V6vSxd25C6ZbVcpMtW7wExWSuCex655", 8.192)  # (m/1/1/1)
        self.sendtodestination("hPgW2cTztpupB7mT9Uab8CV7ocgNKh2vzC", 16.384)  # (m/1/1/1500)
        ...
        unspent = self.nodes[0].scantxoutset("start", ["addr(hPgW2cTztpupB7mT9Uab8CV7ocgNKh2vzC)"])["unspents"][0]

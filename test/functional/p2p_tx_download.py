...
class TxDownloadTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new elevenseventyfived instances, as setting mocktimes has long-term effects on when

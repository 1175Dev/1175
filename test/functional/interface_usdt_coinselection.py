...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/elevenseventyfive/elevenseventyfive/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(ElevenSeventyFiveTestFramework):

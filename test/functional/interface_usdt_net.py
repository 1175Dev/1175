...
try:
    ...
    pass
from test_framework.messages import CBlockHeader, MAX_HEADERS_RESULTS_ACCEPT, msg_headers, msg_version
...
class NetTracepointTest(BitcoinTestFramework):
    ...
    def misbehaving_conn_tracepoint_test(self):
        ...
        msg = msg_headers([CBlockHeader()] * (MAX_HEADERS_RESULTS_ACCEPT + 1))

...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/elevenseventyfive/elevenseventyfive/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(ElevenSeventyFiveTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our elevenseventyfived node")

...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/elevenseventyfive/elevenseventyfive/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(ElevenSeventyFiveTestFramework):

...
This document provides guidelines for internationalization of the ElevenSeventyFive Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `elevenseventyfive_en.ts` remains unchanged.

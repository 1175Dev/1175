ElevenSeventyFive Core version 0.13.2 is now available from:

  <https://elevenseventyfive.org/bin/elevenseventyfive-core-0.13.2/>
...
- #8908 `4a974b2` Update elevenseventyfive-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow elevenseventyfive-tx to create v2 transactions (esfdrak)

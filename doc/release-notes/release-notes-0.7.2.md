ElevenSeventyFive version 0.7.2 is now available from:
  http://sourceforge.net/projects/elevenseventyfive/files/ElevenSeventyFive/elevenseventyfive-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused ElevenSeventyFive-Qt to crash on Windows when exiting.

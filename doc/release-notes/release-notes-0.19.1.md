...
ElevenSeventyFive Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/elevenseventyfive-core-0.19.1/>
...
From ElevenSeventyFive Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as ElevenSeventyFive Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, ElevenSeventyFive Core does not yet change appearance when
...
- #17488 fix "elevenseventyfived already running" warnings on macOS (fanquake)

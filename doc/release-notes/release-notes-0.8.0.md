ElevenSeventyFive-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/elevenseventyfive/files/ElevenSeventyFive/elevenseventyfive-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the ElevenSeventyFive
...
New/changed settings (command-line or elevenseventyfive.conf file)
--------------------------------------------------------

ElevenSeventyFive Core version 0.10.4 is now available from:

  <https://elevenseventyfive.org/bin/elevenseventyfive-core-0.10.4/>
...
- #6953 `43c2789` Split elevenseventyfive-tx into its own package
- #6953 `dfe0d4d` Include elevenseventyfive-tx binary on Debian/Ubuntu

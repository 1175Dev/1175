ElevenSeventyFive Core version 0.9.2.1 is now available from:

  https://elevenseventyfive.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ESF to 0.01 ESF
...
- Fix "Start elevenseventyfive on system login"

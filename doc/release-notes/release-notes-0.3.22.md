Download URL: https://sourceforge.net/projects/elevenseventyfive/files/ElevenSeventyFive/elevenseventyfive-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ESF fee schedule (users still pay 0.01 ESF per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #elevenseventyfive00 - #elevenseventyfive99

ElevenSeventyFive Core version 0.9.4 is now available from:

  https://elevenseventyfive.org/bin/0.9.4/
...
this update is incompatible with the ElevenSeventyFive system and could lead to consensus
forks.

ElevenSeventyFive Core released binaries from https://elevenseventyfive.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~elevenseventyfive/+archive/ubuntu/elevenseventyfive
- A third-party or self-compiled ElevenSeventyFive Core

upgrade to ElevenSeventyFive Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

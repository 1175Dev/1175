ElevenSeventyFive version 0.5.4 is now available for download at:
http://sourceforge.net/projects/elevenseventyfive/files/ElevenSeventyFive/elevenseventyfive-0.5.4/
...
http://gitorious.org/elevenseventyfive/elevenseventyfived-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix ElevenSeventyFive-Qt notifications under Growl 1.3.
Increase required age of ElevenSeventyFive-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxElevenSeventyFive properly when installing ElevenSeventyFive-Qt over it. (Windows)

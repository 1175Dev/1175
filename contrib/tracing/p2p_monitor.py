...
""" Interactive elevenseventyfived P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for ElevenSeventyFive Core can enable. It uses BCC
...
def main(elevenseventyfived_path):
    ...
    elevenseventyfived_with_usdts.enable_probe(

...
"""Example logging ElevenSeventyFive Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/elevenseventyfived
...
def main(elevenseventyfived_path):
    ...
    b = BPF(text=program, usdt_contexts=[elevenseventyfived_with_usdts])

...
EXCLUDE = [
    # auto generated:
    'src/qt/elevenseventyfivestrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The ElevenSeventyFive Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a elevenseventyfive source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The ElevenSeventyFive Core developers'
...
Arguments:
    <file> - A source file in the elevenseventyfive repository.
"""

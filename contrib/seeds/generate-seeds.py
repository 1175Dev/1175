...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ELEVENSEVENTYFIVE_CHAINPARAMSSEEDS_H\n')
    g.write('#define ELEVENSEVENTYFIVE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the elevenseventyfive network\n')
    ...
    g.write('#endif // ELEVENSEVENTYFIVE_CHAINPARAMSSEEDS_H\n')

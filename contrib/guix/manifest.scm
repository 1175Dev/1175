...
(define* (make-elevenseventyfive-cross-toolchain target
                                       #:key
...
desirable for building ElevenSeventyFive Core release binaries."
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-elevenseventyfive-cross-toolchain target)))

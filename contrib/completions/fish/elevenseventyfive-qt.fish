...
complete --command elevenseventyfive-qt --no-files

# Extract options
function __fish_elevenseventyfiveqt_get_options
...
complete \
    --command elevenseventyfive-qt \
    --arguments "(__fish_elevenseventyfiveqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c elevenseventyfive-qt \
...
complete \
    --command elevenseventyfive-qt \
    --arguments "(__fish_elevenseventyfiveqt_get_options --nofiles)"

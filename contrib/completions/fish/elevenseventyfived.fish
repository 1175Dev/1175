...
complete --command elevenseventyfived --no-files

# Extract options
function __fish_elevenseventyfived_get_options
...
complete \
    --command elevenseventyfived \
    --arguments "(__fish_elevenseventyfived_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command elevenseventyfived \
...
complete \
    --command elevenseventyfived \
    --arguments "(__fish_elevenseventyfived_get_options --nofiles)"

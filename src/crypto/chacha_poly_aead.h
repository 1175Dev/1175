...
#ifndef ELEVENSEVENTYFIVE_CRYPTO_CHACHA_POLY_AEAD_H
#define ELEVENSEVENTYFIVE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@elevenseventyfive.
 *
 ...
 *
 * The chacha20-poly1305@elevenseventyfive combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@elevenseventyfive cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@elevenseventyfive are relatively fast in
...
#endif // ELEVENSEVENTYFIVE_CRYPTO_CHACHA_POLY_AEAD_H

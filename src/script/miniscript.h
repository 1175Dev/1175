...
#ifndef ELEVENSEVENTYFIVE_SCRIPT_MINISCRIPT_H
#define ELEVENSEVENTYFIVE_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a elevenseventyfive script
...
#endif // ELEVENSEVENTYFIVE_SCRIPT_MINISCRIPT_H

...
#ifndef ELEVENSEVENTYFIVE_SCRIPT_SCRIPT_H
#define ELEVENSEVENTYFIVE_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, ElevenSeventyFive always counted CHECKMULTISIGs
...
#endif // ELEVENSEVENTYFIVE_SCRIPT_SCRIPT_H

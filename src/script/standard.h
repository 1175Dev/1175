...
#ifndef ELEVENSEVENTYFIVE_SCRIPT_STANDARD_H
#define ELEVENSEVENTYFIVE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a elevenseventyfive address
 */
...
/**
 * Generate a ElevenSeventyFive scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ELEVENSEVENTYFIVE_SCRIPT_STANDARD_H

...
#ifndef ELEVENSEVENTYFIVE_COMPAT_ASSUMPTIONS_H
#define ELEVENSEVENTYFIVE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "ElevenSeventyFive cannot be compiled without assertions."
#endif
...
#endif // ELEVENSEVENTYFIVE_COMPAT_ASSUMPTIONS_H

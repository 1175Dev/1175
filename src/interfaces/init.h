...
#ifndef ELEVENSEVENTYFIVE_INTERFACES_INIT_H
#define ELEVENSEVENTYFIVE_INTERFACES_INIT_H
...
//! (elevenseventyfive-gui, elevenseventyfive-node, elevenseventyfive-wallet, elevenseventyfived, elevenseventyfive-qt) and each
...
#endif // ELEVENSEVENTYFIVE_INTERFACES_INIT_H

...
#ifndef ELEVENSEVENTYFIVE_INTERFACES_NODE_H
#define ELEVENSEVENTYFIVE_INTERFACES_NODE_H
...
//! Top-level interface for a elevenseventyfive node (elevenseventyfived process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or elevenseventyfive.conf.
...
#endif // ELEVENSEVENTYFIVE_INTERFACES_NODE_H

...
#ifndef ELEVENSEVENTYFIVE_IPC_PROCESS_H
#define ELEVENSEVENTYFIVE_IPC_PROCESS_H
...
//! IPC process interface for spawning elevenseventyfive processes and serving requests
...
#endif // ELEVENSEVENTYFIVE_IPC_PROCESS_H

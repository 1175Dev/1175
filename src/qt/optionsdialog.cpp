      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->elevenseventyfiveAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->elevenseventyfiveAtStartup);
    ...
    ui->elevenseventyfiveAtStartup->setToolTip(ui->elevenseventyfiveAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->elevenseventyfiveAtStartup->setText(ui->elevenseventyfiveAtStartup->text().arg(PACKAGE_NAME));

    ui->openElevenSeventyFiveConfButton->setToolTip(ui->openElevenSeventyFiveConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ElevenSeventyFiveUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->elevenseventyfiveAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSESFontrols);
...
void OptionsDialog::on_openElevenSeventyFiveConfButton_clicked()
{
    ...
    if (!GUIUtil::openElevenSeventyFiveConf())

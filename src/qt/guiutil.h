...
#ifndef ELEVENSEVENTYFIVE_QT_GUIUTIL_H
#define ELEVENSEVENTYFIVE_QT_GUIUTIL_H
...
/** Utility functions used by the ElevenSeventyFive Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "elevenseventyfive:" URI into recipient object, return true on successful parsing
...
#endif // ELEVENSEVENTYFIVE_QT_GUIUTIL_H

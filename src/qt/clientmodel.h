...
#ifndef ELEVENSEVENTYFIVE_QT_CLIENTMODEL_H
#define ELEVENSEVENTYFIVE_QT_CLIENTMODEL_H
...
/** Model for ElevenSeventyFive network client. */
...
#endif // ELEVENSEVENTYFIVE_QT_CLIENTMODEL_H

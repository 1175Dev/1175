...
#ifndef ELEVENSEVENTYFIVE_QT_WALLETMODEL_H
#define ELEVENSEVENTYFIVE_QT_WALLETMODEL_H
...
/** Interface to ElevenSeventyFive wallet from Qt view code. */
...
#endif // ELEVENSEVENTYFIVE_QT_WALLETMODEL_H

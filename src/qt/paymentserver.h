...
#ifndef ELEVENSEVENTYFIVE_QT_PAYMENTSERVER_H
#define ELEVENSEVENTYFIVE_QT_PAYMENTSERVER_H

// This class handles payment requests from clicking on
// elevenseventyfive: URIs
//
...
#endif // ELEVENSEVENTYFIVE_QT_PAYMENTSERVER_H

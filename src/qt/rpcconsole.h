...
#ifndef ELEVENSEVENTYFIVE_QT_RPCCONSOLE_H
#define ELEVENSEVENTYFIVE_QT_RPCCONSOLE_H
...
/** Local ElevenSeventyFive RPC console. */
...
#endif // ELEVENSEVENTYFIVE_QT_RPCCONSOLE_H

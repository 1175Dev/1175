...
#ifndef ELEVENSEVENTYFIVE_QT_TRANSACTIONFILTERPROXY_H
#define ELEVENSEVENTYFIVE_QT_TRANSACTIONFILTERPROXY_H
...
#endif // ELEVENSEVENTYFIVE_QT_TRANSACTIONFILTERPROXY_H

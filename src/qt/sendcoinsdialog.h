...
#ifndef ELEVENSEVENTYFIVE_QT_SENDCOINSDIALOG_H
#define ELEVENSEVENTYFIVE_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending elevenseventyfives */
...
#endif // ELEVENSEVENTYFIVE_QT_SENDCOINSDIALOG_H

...
{
    // Test regression https://github.com/elevenseventyfive/elevenseventyfive/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/elevenseventyfive-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/elevenseventyfive-core/gui/pull/568.
    // With fListen=false in ~/.config/ElevenSeventyFive/ElevenSeventyFive-Qt.conf and all else left as default,
    // elevenseventyfive-qt should set both -listen and -listenonion to false and start successfully.

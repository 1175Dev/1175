...
//! Entry point for ElevenSeventyFiveApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ElevenSeventyFiveApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ElevenSeventyFiveGUI tests.
void AppTests::guiTests(ElevenSeventyFiveGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ElevenSeventyFiveGUI::consoleShown, this, &AppTests::consoleTests);

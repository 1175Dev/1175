...
#ifndef ELEVENSEVENTYFIVE_HEADERSSYNC_H
#define ELEVENSEVENTYFIVE_HEADERSSYNC_H
 ...
 *
 * The ElevenSeventyFive protocol does not offer an easy way to determine the work on a
...
#endif // ELEVENSEVENTYFIVE_HEADERSSYNC_H

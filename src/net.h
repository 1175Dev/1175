...
#ifndef ELEVENSEVENTYFIVE_NET_H
#define ELEVENSEVENTYFIVE_NET_H
...
public:
     ...
     * @see https://github.com/elevenseventyfive/elevenseventyfive/issues/21744 for details.
     */

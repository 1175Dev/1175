...
#ifndef ELEVENSEVENTYFIVE_EXTERNAL_SIGNER_H
#define ELEVENSEVENTYFIVE_EXTERNAL_SIGNER_H
...
private:
    ...
    //! ElevenSeventyFive mainnet, testnet, etc
    std::string m_chain;
...
#endif // ELEVENSEVENTYFIVE_EXTERNAL_SIGNER_H

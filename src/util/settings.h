...
#ifndef ELEVENSEVENTYFIVE_UTIL_SETTINGS_H
#define ELEVENSEVENTYFIVE_UTIL_SETTINGS_H
...
//!       https://github.com/elevenseventyfive/elevenseventyfive/pull/15934/files#r337691812)
...
#endif // ELEVENSEVENTYFIVE_UTIL_SETTINGS_H

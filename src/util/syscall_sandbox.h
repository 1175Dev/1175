...
#ifndef ELEVENSEVENTYFIVE_UTIL_SYSCALL_SANDBOX_H
#define ELEVENSEVENTYFIVE_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during elevenseventyfived initialization if ElevenSeventyFive Core was compiled
...
#endif // ELEVENSEVENTYFIVE_UTIL_SYSCALL_SANDBOX_H

...
#ifndef ELEVENSEVENTYFIVE_UTIL_MESSAGE_H
#define ELEVENSEVENTYFIVE_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's elevenseventyfive address, it must refer to a public key.
...
#endif // ELEVENSEVENTYFIVE_UTIL_MESSAGE_H

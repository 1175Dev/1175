...
//
// The elevenseventyfive-chainstate executable serves to surface the dependencies required
// by a program wishing to use ElevenSeventyFive Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from ElevenSeventyFive Core's coding style.
//
// It is part of the libelevenseventyfivekernel project.

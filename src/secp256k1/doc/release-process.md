...
2. After the PR is merged, tag the commit and push it:
   ...
   git push git@github.com:elevenseventyfive-core/secp256k1.git v$MAJOR.$MINOR.$PATCH
   ```
...
1. If `$PATCH = 1`, create maintenance branch `$MAJOR.$MINOR`:
   ...
   git push git@github.com:elevenseventyfive-core/secp256k1.git $MAJOR.$MINOR
   ```

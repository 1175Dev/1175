...
static bool AppInit(NodeContext& node, int argc, char* argv[])
{
    ...
    // If Qt is used, parameters/elevenseventyfive.conf are parsed in qt/elevenseventyfive.cpp's main()
    ...
    if (HelpRequested(args) || args.IsArgSet("-version")) {
        ...
        if (args.IsArgSet("-version")) {
            ...
            strUsage += "\nUsage:  elevenseventyfived [options]                     Start " PACKAGE_NAME "\n"
                "\n";
    ...
    try
    {
        ...
        // -server defaults to true for elevenseventyfived but not for the GUI so do this here
...
MAIN_FUNCTION
{
    ...
    // Connect elevenseventyfived signal handlers
    noui_connect();

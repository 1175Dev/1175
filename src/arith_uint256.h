...
#ifndef ELEVENSEVENTYFIVE_ARITH_UINT256_H
#define ELEVENSEVENTYFIVE_ARITH_UINT256_H
...
public:
     ...
     *
     * ElevenSeventyFive only uses this "compact" format for encoding difficulty
...
#endif // ELEVENSEVENTYFIVE_ARITH_UINT256_H

...
#ifndef ELEVENSEVENTYFIVE_WALLET_WALLETUTIL_H
#define ELEVENSEVENTYFIVE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! elevenseventyfive from opening the wallet, thinking it was newly created, and
...
#endif // ELEVENSEVENTYFIVE_WALLET_WALLETUTIL_H

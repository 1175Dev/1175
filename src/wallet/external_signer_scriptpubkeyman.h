...
#ifndef ELEVENSEVENTYFIVE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ELEVENSEVENTYFIVE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ELEVENSEVENTYFIVE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H

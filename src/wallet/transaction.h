...
#ifndef ELEVENSEVENTYFIVE_WALLET_TRANSACTION_H
#define ELEVENSEVENTYFIVE_WALLET_TRANSACTION_H
...
public:
     ...
     * on this elevenseventyfive node, and set to 0 for transactions that were created
...
#endif // ELEVENSEVENTYFIVE_WALLET_TRANSACTION_H

...
#ifndef ELEVENSEVENTYFIVE_PSBT_H
#define ELEVENSEVENTYFIVE_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual ElevenSeventyFive transaction.) Returns true if the merge succeeded, false otherwise. */
...
#endif // ELEVENSEVENTYFIVE_PSBT_H

...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{"waitfornewblock",
                ...
                "\nMake sure to use no RPC timeout (elevenseventyfive-cli -rpcclienttimeout=0)",
                {
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (elevenseventyfive-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
        ...
        RPCExamples{
            HelpExampleCli("scanblocks", "start '[\"addr(resf1q2yuthd8aq4whjemkc2khwjnq6zd7dmv5sansdt)\"]' 300000") +
            HelpExampleCli("scanblocks", "start '[\"addr(resf1q2yuthd8aq4whjemkc2khwjnq6zd7dmv5sansdt)\"]' 100 150 basic") +
            HelpExampleCli("scanblocks", "status") +
            HelpExampleRpc("scanblocks", "\"start\", [\"addr(resf1q2yuthd8aq4whjemkc2khwjnq6zd7dmv5sansdt)\"], 300000") +
            HelpExampleRpc("scanblocks", "\"start\", [\"addr(resf1q2yuthd8aq4whjemkc2khwjnq6zd7dmv5sansdt)\"], 100, 150, \"basic\"") +
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{"getdescriptoractivity",
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (elevenseventyfive-cli -rpcclienttimeout=0)",
        {
        ...
        RPCExamples{
            HelpExampleCli("getdescriptoractivity", "'[\"000000000000000000001347062c12fded7c528943c8ce133987e2e2f5a840ee\"]' '[\"addr(esf1qjuv0stwwrsw2z0qxag9ndjjcdzyc67vd4q200z)\"]'")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    UniValue ret(UniValue::VOBJ);
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable elevenseventyfived instance that is current with the network tip in a "

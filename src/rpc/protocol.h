...
#ifndef ELEVENSEVENTYFIVE_RPC_PROTOCOL_H
#define ELEVENSEVENTYFIVE_RPC_PROTOCOL_H
...
//! ElevenSeventyFive RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in elevenseventyfived
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< ElevenSeventyFive is not connected
...
#endif // ELEVENSEVENTYFIVE_RPC_PROTOCOL_H

...
#ifndef ELEVENSEVENTYFIVE_TEST_SCRIPTNUM10_H
#define ELEVENSEVENTYFIVE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ElevenSeventyFive Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ELEVENSEVENTYFIVE_TEST_SCRIPTNUM10_H

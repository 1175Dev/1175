...
// 1175 MAIN-encoded (WIF prefix 178, P2PKH prefix 51); re-encoded from the
// upstream Bitcoin mainnet vectors. Private-key payloads are unchanged, so the
// deterministic-signature expectations below remain valid.
static const std::string strSecret1 = "6y9jkX7WCyM9HZshNsLid8eYwS24EDGEddS8mDg7NXb7BvYzkJ2";
static const std::string strSecret2 = "6zPHULHpMBpPmGLCi2A4BEzRp5LWaXtSnKXJDGfniFbcdGrZm2A";
static const std::string strSecret1C = "TLqZh5uhuqhua86mDXC2iUkjyFRfFK8FAfowGAwd821YK2Xiqrwe";
static const std::string strSecret2C = "TSHMhe9Dz6kBUNfkg46y2CkUWn97Z1L4o2kiyAACm5RnF5scsbqM";
static const std::string addr1 = "MvVc3tfuHHCAkVQeYxsq3bkXsTUZNFZVRk";
static const std::string addr2 = "MmKjHmGwZoiEhjRJRYgbJsXB8zN4S8ohZX";
static const std::string addr1C = "Mu355M5aAap1NJQKYvSK1yWRxFZLN9Hc5C";
static const std::string addr2C = "MifVEqB3DQAChPGwaosxzjron6bFjDARi5";

static const std::string strAddressBad = "MoiuZ9FZaVCeeqAyzVeRmXmMrv1642Cmak";

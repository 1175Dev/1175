...
BOOST_AUTO_TEST_CASE(test_assumeutxo)
{
    ...
    //
    // 1175 regtest defines a single assumeutxo snapshot at height 110 (see
    // CRegTestParams m_assumeutxo_data in kernel/chainparams.cpp). Its base blockhash and
    // UTXO-set hash are 1175-specific — the 1175 regtest chain (its genesis and coinbase)
    // differs from Bitcoin's, so upstream's 6657b736…/696e9282… values do not apply.
    ...
    const auto out110_2 = *params->AssumeutxoForBlockhash(uint256{"17e4169766421e62358e27ade90025a55adcb40c34eee4af599cba485eb4ba71"});

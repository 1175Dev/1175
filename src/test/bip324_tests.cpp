    ...
    const std::string& out_ciphertext_endswith_hex)
{
    ...
    // Compare session variables. These expected values are 1175-regenerated: the session_id and
    // garbage terminators are derived from the network magic (salt "bitcoin_v2_shared_secret" +
    // Params().MessageStart()), so with 1175 mainnet magic (74ba1be4) they differ from Bitcoin's
    // upstream BIP324 vectors.
    ...
    // These expected values are 1175-regenerated (magic 74ba1be4): the ciphertext is produced with
    // keys derived from the network magic, so it also differs from Bitcoin's upstream vectors.
    if (!out_ciphertext.empty()) {
        BOOST_CHECK(out_ciphertext == ciphertext);
    } else if (!out_ciphertext_endswith.empty()) {
...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    ...
    TestBIP324PacketVector(
        ...
        "",
        false,
        "0b7f282e2b63a70c1ddb2f7bc86c6d10",
        "1bdd4a4ed73f04201bc499dd687deef3",
        "740dbc1d53b37bcbb76adcd193a34fe908bae595f853e3c7d08d854b10f0f959",
        "e812fe341866cdb284553f9ebf1d1027c71a48a9cb",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "b9ff4cf11cc0f517f9c2420822242ae5",
        "a42e008954de31c18c080f4ba092fcfe",
        "58229592666e4e93e18dfefd35d0b77b6a07efd0557dbb93d33b35034b4b19ca",
        "91715061beed6b298c49b3acdd35bf00d443cef0c32c1ab33fd72fbca105549d368cd73bc0",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "9c2032577d840727865bb1a655035965",
        "10dce65f566400c9bf0f46d15daa9472",
        "fadf61b3296811ff2b486e8b30618860a13a4f123d8d89a6716dbacaa440227c",
        "751edfeacf87dc95e814b7e44713a684665e0942ba23b536c59f0113d6dc52bda70517b1891beda3308f1fe89a464ab82940c3c6ad4aaae7c87b32ad9e4ce200eb699d1b01e3b8f3c5dee5c1931a108b572a89",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "150879159606ed0e353d5ea69dd29ced",
        "2cbf5404df6dd840d6ad9ead8b341b18",
        "3fca8ca615091c3ba6b8cce632229a14e9f4993f28fa7060902b4bfc45f24f80",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "43cdd80d626a34946c579933dad33016",
        "dbc7ec88629da8bcd4b9557b56ce0146",
        "895cd287183da05352c9b801b0deb144d79e067e0cec7d2ad3ed1801657bcdf2",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "a6d57d027145f78a00efdd5c4a1cbf6f",
        "3d925e084cfaf3c29afd533187457c9b",
        "79aeee867ad27a5636b138b0eb6472e27edc05f0bb5791c6b5f83cf587623853",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "c7a54c391f7c9a02738fc603bf8a75cb",
        "892f7b1abf36bf8fb7471474d81d63cb",
        "8ae8e14aefde31a0238c5b68fb9c473f906ed0e654f82dbbe407ae5729a857a9",
        "",
        "");
}

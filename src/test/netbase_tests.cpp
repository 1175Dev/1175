...
{
    BOOST_CHECK(TestSplitHost("www.elevenseventyfivecore.org", "www.elevenseventyfivecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.elevenseventyfivecore.org]", "www.elevenseventyfivecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.elevenseventyfivecore.org:80", "www.elevenseventyfivecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.elevenseventyfivecore.org]:80", "www.elevenseventyfivecore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:25360", "127.0.0.1", 25360));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:25360", "127.0.0.1", 25360));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:25360", "::ffff:127.0.0.1", 25360));
    BOOST_CHECK(TestSplitHost("[::]:25360", "::", 25360));
    BOOST_CHECK(TestSplitHost("::25360", "::25360", 0));
    BOOST_CHECK(TestSplitHost(":25360", "", 25360));
    BOOST_CHECK(TestSplitHost("[]:25360", "", 25360));
    ...
    BOOST_CHECK(TestSplitHost("www.elevenseventyfivecore.org:65536", "www.elevenseventyfivecore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.elevenseventyfivecore.org:0", "www.elevenseventyfivecore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.elevenseventyfivecore.org:", "www.elevenseventyfivecore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:25360", "127.0.0.1:25360"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:25360", "[::]:25360"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

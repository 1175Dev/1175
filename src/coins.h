...
#ifndef ELEVENSEVENTYFIVE_COINS_H
#define ELEVENSEVENTYFIVE_COINS_H
 ...
 * between elevenseventyfived, and elevenseventyfive-qt and non-server tools.
 *
...
#endif // ELEVENSEVENTYFIVE_COINS_H

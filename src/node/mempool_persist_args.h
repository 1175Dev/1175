...
#ifndef ELEVENSEVENTYFIVE_NODE_MEMPOOL_PERSIST_ARGS_H
#define ELEVENSEVENTYFIVE_NODE_MEMPOOL_PERSIST_ARGS_H
...
#endif // ELEVENSEVENTYFIVE_NODE_MEMPOOL_PERSIST_ARGS_H
